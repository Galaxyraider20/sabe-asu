  ...
  return (
    <div className="min-h-screen bg-slate-950 text-white">
      <div className="relative isolate overflow-hidden bg-gradient-to-b from-amber-500/20 via-slate-950 to-slate-950">
        ...
        <header className="relative mx-auto flex max-w-6xl flex-col gap-4 px-6 pb-20 pt-6">
          <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
            <div>
              ...
              <p className="mt-6 max-w-2xl text-lg text-slate-200">
                SABE unites builders, strategists, and innovators who want to solve
                complex problems with both a spreadsheet and a CAD model. We design
                immersive experiences that help Sun Devils ship ideas that matter.
              </p>
            ...
            <div className="w-full max-w-md rounded-3xl border border-white/10 bg-white/5 p-6 backdrop-blur">
              ...
              <p className="mt-3 text-sm leading-relaxed text-slate-200">
                From venture studio cohorts to site visits at Intel Chandler, SABE
                offers pathways to explore entrepreneurship, systems design, and
                business strategy through the same lens.
              </p>
        ...
        >
          <div className="flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
            <div>
              ...
              <h2 className="text-3xl font-semibold">Meet the leadership team</h2>
            </div>
            <p className="text-sm text-slate-300 md:max-w-md">
              SABE is fully student-run with support from faculty partners across W.
              P. Carey, Fulton Schools, and the J. Orin Edson Entrepreneurship hub.
            </p>
          </div>
